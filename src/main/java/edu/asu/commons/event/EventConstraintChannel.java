...
public final class EventConstraintChannel implements EventGenerator, EventChannel {
     ...
     *
     * @param event The event to distribute via this EventChannel.
     */
     ...
     *
     * @param handler The EventHandler to subscribe.
     * @param constraint The constraint with which to filter events.
     */
     ...
     *
     * @param handler The EventHandler to unsubscribe.
     */
